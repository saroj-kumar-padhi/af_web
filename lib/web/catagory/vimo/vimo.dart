...
class VimoPageWeb extends StatelessWidget {
  const VimoPageWeb({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: ListView.builder(
            itemCount: Vimo1.length, // Number of items in your list
              ...
              child: TextFormField(
                ...
                decoration: const InputDecoration(
                  ...
                  prefixIcon: Padding(
                    ...
                    child: Text('+1', // Replace with your default country code
                        style: TextStyle(
                          fontSize: 25.0,
                          fontWeight: FontWeight.bold,
                          color: Color.fromRGBO(89, 83, 83, 1),
