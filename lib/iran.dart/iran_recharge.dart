...
class IranRechargePage extends StatelessWidget {
  const IranRechargePage({super.key});
    ...
    return Scaffold(
      body: Column(children: [
        ...
        Row(
          ...
          children: [
            CustomWallet4(
                image: 'assets/mtn-irancell-logo-27B4584F73-seeklogo.com.png'),
            CustomWallet4(
                image: 'assets/Logo-persian_preview-removebg-preview.png'),
            CustomWallet4(
                image: 'assets/Hamrah_avval_logo-removebg-preview.png'),
            CustomWallet4(image: 'assets/download__1_-removebg-preview.png'),
